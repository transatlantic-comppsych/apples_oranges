...
# here I extract the coefficients
...
# Double coding SE for argyris
double_check <- list_df_simulated[[1]] 

double_check <- double_check %>% 
  mutate (se_check = sqrt(  ((2*(1 - correlation_sim_values )/baseline_n) + (cohens_d^2/ 2*baseline_n) )))
