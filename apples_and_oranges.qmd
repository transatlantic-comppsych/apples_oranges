...
z_psy_con_vs_med_con[i] <- list_model_1_no_wl[[i]]$zval[condition=="psychotherapy_control"]
...
subgroup_cdrs_baseline_control <- update.meta(means_cdrs_baseline_control, 
            subgroup = psy_or_med, 
            tau.common = FALSE)
...
means_cdrs_baseline_active <- metamean(n = baseline_n_active,
                                        ...
                                        hakn = TRUE,
                                        title = "CDRS Scores at Baseline")
#summary(means_cdrs_baseline_active)

subgroup_cdrs_baseline_active <- update.meta(means_cdrs_baseline_active, 
            subgroup = psy_or_med, 
            tau.common = FALSE)
...
subgroup_hamd_baseline_control <- update.meta(means_hamd_baseline_control, 
            subgroup = psy_or_med, 
            tau.common = FALSE)
...
subgroup_hamd_baseline_active <- update.meta(means_hamd_baseline_active, 
            subgroup = psy_or_med, 
            tau.common = FALSE)
