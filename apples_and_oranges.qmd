...
$$ SE_{change} = \sqrt{\frac{r_{t_{1}t_{2}}}{n} + \frac{SMD^2}{2n}}$$ {#eq-4}
...
<!--# Charlotte, for the paragraph below, please provide the numbers for each of the numbers wherever I have put an X -->

Placebo was the control condition for all medication trials; the active arm ranged from serotonin reuptake inhibitors, such as <!--# X -->fluoxetine and <!--# X -->escitalopram, to tricylics, such as <!--# X -->notriptylin. In psychological trials, the control arm included <!--# X -->WL controls, care as usual <!--# X --> and several other conditions such as attention control <!--# X -->; the active arm included CBT <!--# X -->, IPT <!--# X --> and psychodynamic therapy <!--# X --> amongst others. All included trials and the types of treatment controls can be found in Suppelmenateray Table 1.
