...
We addressed potential regression to the mean by residualising SMDs by the percentage adjusted baseline scores in one regression model (see @tbl-adj-smds in the Supplement). The difference between the medication control and psychotherapy control arms remained similar to the overall analyses.
