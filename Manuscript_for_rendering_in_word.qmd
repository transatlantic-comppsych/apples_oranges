...
flextable(df_sites_summary_stats) %>%
  set_caption ("Number of sites across medication and psychotherapy studies", style = "Table Caption") %>%
  bold(part = "header") %>%  
