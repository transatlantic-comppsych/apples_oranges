...
extract_i2_values <- function(list_of_models) {
  ...
  for (i in seq_along(list_of_models)) {
    ...
    i2_results <- dmetar::var.comp(model)
...
flextable(table_aggregate_results_overall) %>%
  set_table_properties(width = 1) %>%
  autofit() %>%
  add_footer_row(values = as_paragraph("T", as_sup("2"), as_sub("L3"), " = ", aggregate_results_overall[1, "T2_1"], ";", as_i("T"), as_sup("2"), as_sub("L2"), " = ", aggregate_results_overall[1, "T2_2"],
                      "; ", as_i("I"), as_sup("2"), as_sub("L3"), " = ", aggregate_results_overall[1, "I2_3"], 
                      "; ", as_i("I"), as_sup("2"), as_sub("L2"), " = ", aggregate_results_overall[1, "I2_2"], 
                      "; ", as_i("K"), " = ", aggregate_results_overall[1, "k"], "."), colwidths = 6) %>%
